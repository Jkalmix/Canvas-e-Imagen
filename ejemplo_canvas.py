...
line_id = canvas.create_line(50, 50, 200, 50, 200, 80, # De (50,50) a (200,50)
...
rect_id = canvas.create_rectangle(250, 50, 400, 120,
...
oval_id = canvas.create_oval(450, 50, 550, 150, # Un cuadrado delimitador para un círculo
        fill="red",
        outline="maroon",
        width=2)
...
poly_id = canvas.create_polygon(50, 200, 150, 200, 100, 280, # Coordenadas para un triángulo
                                   fill="purple",
                                   outline="darkviolet",
                                   width=3)
...
arc_id_pieslice = canvas.create_arc(250, 200, 400, 300,
                                        start=45, extent=180, # Empieza a 45 grados, se extiende 180
                                        fill="yellow",
                                        outline="orange",
                                        width=2,
                                        style=tk.PIESLICE) # Estilo: sector de pastel
canvas.create_text(325, 310, text="Arco (Pie Slice)", font=("Arial", 9), fill="gray")

arc_id_arc = canvas.create_arc(450, 200, 550, 300,
                                    start=0, extent=270,
                                    outline="blue",
                                    width=3,
...
text_id = canvas.create_text(300, 350,
                                 text="¡Hola, Canvas! Este es un texto.",
                                 font=("Verdana", 16, "bold"),
                                 fill="navy",
                                 anchor=tk.CENTER) # El texto se centra en (300, 350)
    
    # Podemos cambiar el ancla para alineación
canvas.create_text(50, 380, text="Texto alineado a la izquierda", font=("Courier New", 10), fill="black", anchor=tk.NW)
